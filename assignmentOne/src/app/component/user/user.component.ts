...
export class UserComponent implements OnInit {
  ...
  fillUsersArray(): void {
    ...
    this.users.push({
      id: '2',
      name: { firstName: 'Akram', lastName: 'hassouna' },
      birthDate: '22/10/1973',
      email: 'akram@hotmail.com',
      phone: '0593685471',
      address: 'Gaza',
    });
    this.users.push({
      id: '3',
      name: { firstName: 'Yousef', lastName: 'hassouna' },
      birthDate: '5/5/2010',
    ...
    this.users.push({
      id: '4',
      name: { firstName: 'Mahmmoud', lastName: 'hassouna' },
      birthDate: '5/8/1998',
    ...
    this.users.push({
      id: '6',
      name: { firstName: 'Ali', lastName: 'hassouna' },
      birthDate: '5/8/1998',
    ...
    this.users.push({
      id: '8',
      name: { firstName: 'Sara', lastName: 'hassouna' },
      birthDate: '5/8/1998',
    ...
    this.users.push({
      id: '9',
      name: { firstName: 'Mona', lastName: 'hassouna' },
      birthDate: '5/5/2010',
      email: 'Mona@hotmail.com',
      phone: '059541236',
      address: 'Gaza',
    });
    this.users.push({
      id: '10',
      name: { firstName: 'Shrouq', lastName: 'hassouna' },
      birthDate: '5/8/1998',
      email: 'Shrouq@hotmail.com',
      phone: '0596784123',
      address: 'Gaza',
    });
  }
  ...
  onClickAdd(): void {
    ...
    if (!this.isEdit) this.isAdd = true;
    else {
      this.msg = true;
    }
  }
  //when click on create button then fill users array
  addUser(): void {
    this.errorMsg = false;
    if (
      this.id &&
